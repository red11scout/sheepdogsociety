    ...
    <>
      ...
      <section className="relative overflow-hidden bg-background text-foreground">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-20 md:px-12 md:py-32">
          ...
          <p className="mt-10 max-w-2xl font-pullquote text-xl italic leading-relaxed text-foreground/70 md:text-2xl">
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 md:px-12 md:py-24">
          {eventsWithPhotos.length === 0 ? (
            <div className="border border-dashed border-foreground/15 p-16 text-center">
              ...
              <h2 className="display-xl mt-6 text-2xl text-foreground md:text-3xl">
              ...
              {eventsWithPhotos.map((ev) => {
                ...
                return (
                  <li key={ev.id}>
                    <Link
                      href={`/gallery/${ev.id}`}
                      className="lift group/event block overflow-hidden border border-foreground/15 bg-card transition-colors hover:border-brass"
                    >
                      ...
                      <div className="relative aspect-[4/5] w-full overflow-hidden bg-foreground/5">
                        ...
                        <div
                          className="pointer-events-none absolute inset-0 bg-gradient-to-t from-foreground/85 via-foreground/15 to-transparent"
                          aria-hidden
                        />
                        ...
                        <div className="absolute inset-x-0 bottom-0 p-5 text-background">
                          ...
                          <h3 className="display-xl mt-2 text-2xl text-background md:text-3xl">
                            {ev.title}
                          </h3>
                          {ev.location && (
                            <p className="mt-2 text-xs uppercase tracking-[0.18em] text-background/70">
                              {ev.location}
                            </p>
                          )}
                        </div>

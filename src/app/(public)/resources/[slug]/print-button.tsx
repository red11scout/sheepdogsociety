...
export function PrintButton({
  ...
  return (
    <button
      ...
      className="lift inline-flex h-11 items-center gap-2 border border-foreground/20 bg-foreground px-4 text-xs font-medium uppercase tracking-wider text-background transition-colors hover:bg-brass hover:text-iron"

...
export const THEME_DATA = [
  { id: "pasture-iron", light: {}, dark: {} },
  {
    ...
    dark: {
      ...
      "--destructive": "oklch(0.66 0.17 30)", "--border": "oklch(0.32 0.03 45)",
  ...
  },
  {
    ...
    dark: {
      ...
      "--destructive": "oklch(0.66 0.17 30)", "--border": "oklch(0.31 0.024 250)",
  ...
  },
  {
    ...
    dark: {
      ...
      "--destructive": "oklch(0.66 0.17 30)", "--border": "oklch(0.34 0.02 255)",
  ...
  },
  {
    ...
    dark: {
      ...
      "--destructive": "oklch(0.66 0.17 30)", "--border": "oklch(0.32 0.025 165)",

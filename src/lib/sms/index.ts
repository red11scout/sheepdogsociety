...
export const HELP_RESPONSE_TEXT = `Acts 2:28 Sheepdog Society — for support, email shepherd@acts2028sheepdogsociety.com. Msg & data rates may apply. Reply STOP to unsubscribe.`;
